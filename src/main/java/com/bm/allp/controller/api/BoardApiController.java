...
public class BoardApiController {
	...
	public ResponseDto<Integer> boardSave(@RequestBody Board requestBoard, @AuthenticationPrincipal PrincipalDetail principal) {
		
		// System.out.println("BoardApiController : 글 작성 boardSave 호출");
		
		boardService.글작성(requestBoard, principal.getUser());
	...
	public ResponseDto<Integer> boardUpdate(@PathVariable int id, @RequestBody Board updateBoard){
		
		// System.out.println("BoardApiController : 글 수정 boardUpdate 호출"); 
		
		boardService.글수정(id, updateBoard);
	...
	public ResponseDto<Integer> boardDelete(@PathVariable int id){
		...
		// System.out.println("BoardApiController : 글 삭제 boardDeleteById 호출");
